...
const CommissioningModal: React.FC<CommissioningProps> = ({
  open,
  onClose,
  onSubmit,
  editRecord,
        ...
        <Row gutter={12}>
          <Col span={12}>
            <Form.Item
              ...
              name="engineer"
              rules={[
                { required: true, message: "Please enter engineer name" },
              ]}
            >
              <Input />
            </Form.Item>
          ...
          <Col span={12}>
            <Form.Item
              ...
              name="confirmedDate"
              rules={[
                { required: true, message: "Please select confirmed date" },
              ]}
            >
              <DatePicker style={{ width: "100%" }} />
            </Form.Item>
